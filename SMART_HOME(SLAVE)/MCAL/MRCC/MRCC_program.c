...
/**************************************************************** RCC PLL configuration register (RCC_PLLCFGR *******************************************************************/
		 ...
		 /* Bits 14:6 PLLN: Main PLL (PLL) multiplication factor for VCO,                                VCO output frequency = VCO input frequency Ã— PLLN with 192 â‰¤ PLLN â‰¤ 432*/
		 /*PLLN = 192*/
		 RCC_PLLCFGR |= (192<<6);

		 /* Bits 5:0 PLLM: Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock     VCO input frequency = PLL input clock frequency / PLLM with 2 â‰¤ PLLM â‰¤ 63 */
		 /*PLLN = 16*/
		 RCC_PLLCFGR |= (16<<0);
/************************************************************************************************************************************************************************************/
