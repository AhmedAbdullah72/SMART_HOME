...
void MGPIO_voidTogglePin(u8 Copy_u8PortNum ,u8 Copy_u8PinNum)
{
	switch(Copy_u8PortNum)
	{
	case _GPIOA_PORT :  TOGGEL_BIT(MGPIOA ->ODR,Copy_u8PinNum); break;

	case _GPIOB_PORT :  TOGGEL_BIT(MGPIOB ->ODR,Copy_u8PinNum); break;

	case _GPIOC_PORT :  TOGGEL_BIT(MGPIOC ->ODR,Copy_u8PinNum); break;

	case _GPIOD_PORT :  TOGGEL_BIT(MGPIOD ->ODR,Copy_u8PinNum); break;

	case _GPIOE_PORT :  TOGGEL_BIT(MGPIOE ->ODR,Copy_u8PinNum); break;

	case _GPIOH_PORT :  TOGGEL_BIT(MGPIOH ->ODR,Copy_u8PinNum); break;
